/**
 * Sample SR6 characters for development and testing.
 * Used by the "Load Samples" button on the Dashboard.
 */

export function getSampleCharacters() {
  ...
  return [
    {
      ...
      ids_lifestyles: {
        sins: [{ id: "sin1", name: "John Smith", rating: 4 }],
        licenses: [
          { id: "l1", name: "Concealed Carry", rating: 4, sin_id: "sin1" },
        ],
        lifestyles: [
          { id: "ls1", name: "Middle", tier: "Middle", months_paid: 3 },
        ],
        nuyen: 2340,
      },
      personal_info: {
        ...
        backstory:
          "Grew up in the Ork Underground, learned to fight before he could read.",
      },
      karma_ledger: [
        {
          id: "k1",
      ...
      notes: [
        {
          ...
          title: "Session Notes",
          content:
            "First run went sideways. Need better recon next time.",
        },
      ],
      matrix_stats: {
        device_rating: 2,
    ...
    },
    {
      ...
      ids_lifestyles: {
        sins: [{ id: "sin1", name: "Alex Park", rating: 2 }],
        licenses: [],
        lifestyles: [
          { id: "ls1", name: "Low", tier: "Low", months_paid: 6 },
        ],
        nuyen: 870,
      },
      personal_info: {
        ...
        backstory:
          "Emerged as a technomancer at 16, been hiding it since.",
      },
      karma_ledger: [
        {
          id: "k1",
      ...
      other_abilities: [
        {
          id: "oa1",
          name: "Living Persona",
          description: "Can access the Matrix without a device",
        },
      ],
      vehicles: [],
      notes: [],
    ...
    },
    {
      ...
      ids_lifestyles: {
        sins: [{ id: "sin1", name: "Elara Moonwhisper", rating: 3 }],
        licenses: [
          { id: "l1", name: "Mage License", rating: 3, sin_id: "sin1" },
        ],
        lifestyles: [
          { id: "ls1", name: "Low", tier: "Low", months_paid: 2 },
        ],
        nuyen: 450,
      },
      personal_info: {
        ...
        backstory:
          "Trained in a remote elven community, came to the sprawl seeking answers about a mentor spirit.",
      },
      karma_ledger: [
        {
          id: "k1",
    ...
    },
    {
      ...
      ids_lifestyles: {
        sins: [
          { id: "sin1", name: "Victoria Sterling", rating: 6 },
          { id: "sin2", name: "Jane Doe", rating: 2 },
        ],
        licenses: [],
        lifestyles: [
          { id: "ls1", name: "High", tier: "High", months_paid: 1 },
        ],
        nuyen: 8200,
      },
      personal_info: {
        ...
        backstory:
          "Former corporate negotiator who went freelance after discovering her employer's darkest secrets.",
      },
      karma_ledger: [
        {
          id: "k1",
