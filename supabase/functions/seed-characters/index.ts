...
const SAMPLE_CHARACTERS = [
  {
    ...
    personal_info: { ethnicity: "Ork", age: 28, sex: "Male", height: "195cm", weight: "120kg", reputation: 2, description: "A heavily augmented ork street samurai with a no-nonsense attitude.", backstory: "Grew up in the Ork Underground, learned to fight before he could read." },
  ...
  },
  {
    ...
    personal_info: { ethnicity: "Human", age: 22, sex: "Non-binary", height: "165cm", weight: "55kg", reputation: 2, description: "Slight, pale, always distracted by data streams only they can see.", backstory: "Emerged as a technomancer at 16, been hiding it since." },
    karma_ledger: [{ id: "k1", type: "creation", amount: 50, description: "Starting Karma", timestamp: new Date().toISOString() }],
    spells: [],
    adept_powers: [],
  ...
  },
  {
    ...
    personal_info: { ethnicity: "Elf", age: 45, sex: "Female", height: "178cm", weight: "58kg", reputation: 2, description: "Ethereal presence, silver-white hair, eyes that shift color with the astral.", backstory: "Trained in a remote elven community, came to the sprawl seeking answers about a mentor spirit." },
    karma_ledger: [{ id: "k1", type: "creation", amount: 50, description: "Starting Karma", timestamp: new Date().toISOString() }],
    adept_powers: [],
    other_abilities: [],
    vehicles: [],
  ...
  },
  {
    ...
    personal_info: { ethnicity: "Human", age: 34, sex: "Female", height: "170cm", weight: "62kg", reputation: 5, description: "Could be anyone. Forgettable face, perfect posture, designer clothes.", backstory: "Former corporate negotiator who went freelance after discovering her employer's darkest secrets." },
    karma_ledger: [{ id: "k1", type: "creation", amount: 50, description: "Starting Karma", timestamp: new Date().toISOString() }],
    spells: [],
    adept_powers: [],
    other_abilities: [],
